...
from .views import (DivisionCreateView, DivisionDeleteView, DivisionDetailView,
                    DivisionHeadCreateView, DivisionHeadDeleteView,
                    DivisionHeadListView, DivisionListView, DivisionUpdateView)
...
urlpatterns = [
    ...
    path('head/register/', DivisionHeadCreateView.as_view(),
         name="division-head-register"),
    path('head/', DivisionHeadListView.as_view(), name="division-head-delete"),
    path('head/<slug:id>/delete/', DivisionHeadDeleteView.as_view(),
         name="division-head-delete"),
]
